...
public class CategoryController {
    ...
    public ResponseEntity<Response<PostCategoryResponse>> registerCategory(
    ...
    public ResponseEntity<Response<PutCategoryUpdateResponse>> updateCategory(
    ...
    @GetMapping
    public ResponseEntity<Response<GetCategoryListWrapper>> getCategoryList() {
