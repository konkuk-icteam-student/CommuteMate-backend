...
public class AdminScheduleService {
     ...
     */
    @Transactional
    public void processChangeRequest(Integer requestId, CodeType statusCode, Integer adminId) {
        // 변경 요청 조회
        WorkChangeRequest request = workChangeRequestRepository.findById(requestId)
